  ...
  return (
    <div className="relative flex items-center gap-1">
      ...
      <button
        ...
        className={`flex h-8 w-8 items-center justify-center rounded-md border transition ${isPlaying ? "border-amber-500/70 bg-amber-500/10 text-amber-300" : "border-[#394252] bg-[#171d28] text-stone-400 hover:border-amber-500 hover:text-amber-300"}`}
      >
      ...
      <Music className="ml-1 h-3.5 w-3.5 text-stone-600" aria-hidden="true" />
    </div>
  );
}