...
<h1 className="mt-2 font-sans text-2xl font-semibold text-[#f1eee8]">Instructor Workstation</h1>
          ...
          {activeTab === "builder" && <div className="flex min-w-0 flex-col items-stretch gap-2 md:items-end">
            <div className="flex flex-wrap items-center justify-end gap-2">
              {newLesson.instructorGuidance.trim() && <button type="button" onClick={() => setGuidanceOpen(true)} aria-expanded={guidanceOpen} className="flex items-center gap-1.5 rounded-md border border-amber-500/40 px-3 py-2 text-xs font-semibold text-amber-300 transition hover:border-amber-400 hover:bg-amber-500/10"><Lightbulb className="h-3.5 w-3.5" />Lesson Guidance</button>}
